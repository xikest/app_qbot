...
class MultplIndicators(Indicators):
    ...
    @Plot(mode_binary=True, plot_type="line", draw_horiz={"Shiller PE Ratio by Month": "CAPE:26, CAPE:32"}, secondary_plot='pct_change')
    @index_to_datetime
    @validate_date
    def _request(self, url: str = "https://www.multpl.com/shiller-pe/table/by-month", name: str = None,
                 start: str = "2020-01-01", end: str = None, *args, **kwargs) -> Series | BinaryIO:
